...
const App = (props) => {
  ...
  //   },
  //   {
  //     title: 'Sand second great wall of China ',
  ...
  return (
    <div className=" flex items-center justify-center ">
      <div className="relative">
        <div
          className={
            styles.container + ' lg:w-[300px] lg:h-[300px] ' + styles.body + ' '
          }
        >
          {images.map((image, i) => (
            <div
        ...
        <button
          className={styles.button + ' dark:bg-[#ffc0cb] ' + styles.shadow}
          onClick={next}
        >
          <svg color="pink" width="24" height="24" viewBox="0 0 24 24">
            {' '}
...
const Image = ({ url, open, inPlace, id, onInPlace, total }) => {
